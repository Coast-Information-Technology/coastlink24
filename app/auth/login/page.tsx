          ...
          <form onSubmit={handleLogin} className="space-y-4 pt-10">
            ...
            <div>
              ...
              <Input
                ...
                className="w-full px-3 py-5 border border-gray-300 rounded-md dark:bg-white text-black dark:text-black"
                required
              />
              {errors.email && (
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full px-3 py-5 border border-gray-300 rounded-md pr-10 dark:bg-white text-black dark:text-black"
                  required
                />
                <button
                  type="button"
